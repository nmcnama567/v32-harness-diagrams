...
cut length: 2.0 m up the rear-left ROPS leg, about 0.9 m across the roof, plus the cab tail. The trunk
forks at the box into two legs of about 0.30 m, one per Weipu cable plug.

| ROOF cavity | Circuit | AWG | Class | Leg | Plug · pin |
|---|---|---|---|---|---|
| A | STARLINK_13V (FH4) | 16 | PWR | box power | SP21 · 1 |
| B | STARLINK_GND | 16 | GND | box power | SP21 · 2 |
| E | BCN_13V (FH5, K53 switched) | 16 | PWR | box power | SP21 · 3 |
| F | BCN_GND | 16 | GND | box power | SP21 · 4 |
| J | ES_RX (always on) | 18 | SAFE | e-stop RX | SP13 · 1 |
| L | RX_GND | 18 | GND | e-stop RX | SP13 · 2 |
| K | RX_STAT | 20 | SAFE | e-stop RX | SP13 · 3 |
| C, D, G, H, M, N, P | LiDAR power, LiDAR CAN, spare pair, plugged cavity | — | — | — | sealed (TE 114017) |

SP13 · 4 is spare. The plug's wire-side view is the mirror of the receptacle rear view; the cavity
...
| SP13 4-pin cup 1 | receiver RED (9–30 V) | receiver pigtail, 18 AWG | 0.91 m pigtail |
| SP13 4-pin cup 2 | receiver BLACK (GND) | receiver pigtail, 18 AWG | |
| SP13 4-pin cup 3 | receiver WHITE (E-stop output 1, sourcing) | receiver pigtail, 18 AWG | |
...
| Box power plug | Weipu SP2110/P4 (cable plug, 4-pin) | 1 |
| E-stop RX plug | Weipu SP1310/P4 (cable plug, 4-pin) | 1 |
| Wall sockets | Weipu SP2112/S4, SP1312/S4, SP1312/S2 (beacon out) | 1 each |
| Beacon cord plug | Weipu SP1310/P2 | 1 |
| Split gland | icotek KVT-ER 63|4 (45456) | 1 |
| Wire | 16 AWG red/black (two pairs), 18 AWG violet + black, 20 AWG violet, braided loom | 3.5 m each |
...
the SP13 2-pin beacon socket. That is why the SP21 is the 4-pin version.
